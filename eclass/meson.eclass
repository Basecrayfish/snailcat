...
# @VARIABLE: MESON_EXTRA_BUILD_PKG_CONFIG_PATH
# @DEFAULT_UNSET
# @DESCRIPTION:
# Location of pkg-config paths meson should search before all others for DEPEND deps

# @VARIABLE: MESON_EXTRA_PKG_CONFIG_PATH
# @DEFAULT_UNSET
# @DESCRIPTION:
# Location of pkg-config paths meson should search before all others for BDEPEND deps
...
meson_src_configure() {
	...
	local MESON_EXTRA_BUILD_PKG_CONFIG_PATH=${MESON_EXTRA_BUILD_PKG_CONFIG_PATH}
	local MESON_EXTRA_PKG_CONFIG_PATH=${MESON_EXTRA_PKG_CONFIG_PATH}
	...
	local mesonargs=(
		...
		--build.pkg-config-path "${MESON_EXTRA_BUILD_PKG_CONFIG_PATH}${BUILD_PKG_CONFIG_PATH}${BUILD_PKG_CONFIG_PATH:+:}${EPREFIX}/usr/share/pkgconfig"
		--pkg-config-path "${MESON_EXTRA_PKG_CONFIG_PATH}${PKG_CONFIG_PATH}${PKG_CONFIG_PATH:+:}${EPREFIX}/usr/share/pkgconfig"
