...
STATIC_LIB_DEPEND=">=dev-lang/execline-2.6.1.1:=[static-libs]
	>=dev-libs/skalibs-2.9.3.0:=[static-libs]
	>=sys-apps/s6-2.9.2.0:=[static-libs]
"

SHARED_LIB_DEPEND=">=dev-lang/execline-2.6.1.1:=[shared-libs]
	>=dev-libs/skalibs-2.9.3.0:=[shared-libs]
	>=sys-apps/s6-2.9.2.0:=[shared-libs]
"
