...
IUSE="+execline pie +shared-libs static static-libs +static-pic"

REQUIRED_USE="static? ( static-libs )
	pie? ( static static-libs !shared-libs !static-pic )" # Currently, only static-pie is supported

STATIC_LIB_DEPEND="
	execline? ( >=dev-lang/execline-2.6.0.1:=[static-libs] )
	>=dev-libs/skalibs-2.9.2.1:=[static-libs]
"

SHARED_LIB_DEPEND="
	execline? ( >=dev-lang/execline-2.6.0.1:=[shared-libs] )
	>=dev-libs/skalibs-2.9.2.0:=[shared-libs]
"
