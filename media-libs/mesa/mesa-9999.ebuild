...
inherit flag-o-matic llvm meson multilib-minimal python-any-r1 linux-info
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-9999_20201013-elftoolchain-fix.patch
	"${FILESDIR}"/${PN}-9999_20201013-musl-fcntl.patch
)
