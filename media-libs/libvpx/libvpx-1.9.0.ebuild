...
PATCHES=(
	...
	"${FILESDIR}/libvpx-1.9.0-cat-n-replacement.patch"
	"${FILESDIR}/libvpx-1.9.0-disable-strip.patch"
)
...
multilib_src_configure() {
	# Build fails when FORTIFY_SOURCE is defined as libvpx redefines it
