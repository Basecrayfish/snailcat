...
IUSE="aio debug +http +http2 +http-cache +ipv6 libatomic libressl luajit +pcre
	pcre-jit pie rtmp selinux ssl static threads userland_GNU vim-syntax"
...
STATIC_DEPEND="
	...
	pcre-jit? ( dev-libs/libpcre:=[jit,static-libs(+)] )
	ssl? (
		!libressl? ( dev-libs/openssl:0=[static-libs(+)] )
		libressl? ( dev-libs/libressl:=[static-libs(+)] )
	)
	http2? (
		!libressl? ( >=dev-libs/openssl-1.0.1c:0=[static-libs(+)] )
		libressl? ( dev-libs/libressl:=[static-libs(+)] )
	)
	http-cache? (
		userland_GNU? (
	...
	nginx_modules_http_geoip? ( dev-libs/geoip[static-libs(+)] )
	nginx_modules_http_geoip2? ( dev-libs/libmaxminddb:=[static-libs(+)] )
	nginx_modules_http_gunzip? ( sys-libs/zlib[static-libs(+)] )
	nginx_modules_http_gzip? ( sys-libs/zlib[static-libs(+)] )
	nginx_modules_http_gzip_static? ( sys-libs/zlib[static-libs(+)] )
	nginx_modules_http_image_filter? ( media-libs/gd:=[jpeg,png,static-libs(+)] )
	nginx_modules_http_rewrite? ( dev-libs/libpcre:=[static-libs(+)] )
	nginx_modules_http_secure_link? (
		userland_GNU? (
			!libressl? ( dev-libs/openssl:0=[static-libs(+)] )
			libressl? ( dev-libs/libressl:=[static-libs(+)] )
	...
	nginx_modules_http_xslt? ( dev-libs/libxml2:=[static-libs(+)] dev-libs/libxslt[static-libs(+)] )
	nginx_modules_http_lua? ( dev-lang/luajit:2=[static-libs(+)] )
	nginx_modules_http_metrics? ( dev-libs/yajl:=[static-libs(+)] )
	nginx_modules_http_dav_ext? ( dev-libs/libxml2[static-libs(+)] )
	nginx_modules_http_security? (
	...
	nginx_modules_http_auth_ldap? ( net-nds/openldap[ssl?,static-libs] )
	nginx_modules_stream_geoip? ( dev-libs/geoip[static-libs(+)] )
	nginx_modules_stream_geoip2? ( dev-libs/libmaxminddb:=[static-libs(+)] )"
CDEPEND="nginx_modules_http_security? ( www-servers/apache )"
RDEPEND="${CDEPEND}
	!static? ( ${DYNAMIC_DEPEND} )
...
REQUIRED_USE="pcre-jit? ( pcre )
	...
	static? ( !arm !libatomic !nginx_modules_http_perl !nginx_modules_http_brotli !nginx_modules_http_auth_pam )"
