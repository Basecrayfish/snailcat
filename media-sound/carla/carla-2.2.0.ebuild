...
PATCHES=(
	"${FILESDIR}/${PN}-2.2.0-libcxx-atomic.patch"
)
...
src_prepare() {
	...
	if use elibc_musl; then
		eapply "${FILESDIR}/${PN}-2.2.0-musl-array.patch"
		eapply "${FILESDIR}/${PN}-2.2.0-musl-backtrace.patch"
		eapply "${FILESDIR}/${PN}-2.2.0-musl-locale.patch"
	fi
}
