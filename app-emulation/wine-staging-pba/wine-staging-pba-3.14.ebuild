...
if [[ ${PV} == "9999" ]] ; then
	EGIT_REPO_URI="https://gitlab.com/Firer4t/wine-pba-patched.git"
	EGIT_BRANCH="master"
	inherit git-r3
	SRC_URI=""
	#KEYWORDS=""
	...
	SRC_URI="https://gitlab.com/Firer4t/wine-pba-patched/-/archive/wine-staging-pba-v3.14/wine-pba-patched-wine-staging-pba-v3.14.tar.gz"
